...
<script>
    $(function () {
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/res_all",
            success:function (data) {
                ...
                for (var i = 0; i <data.length ; i++) {
                    var url =" ${pageContext.request.contextPath}/jsps/back/"+data[i].resCode+".jsp";
                    str+="   <li data-name=\"home\" class=\"layui-nav-item layui-nav-itemed\">\n" +
                        "                        <a lay-href="+url+" class='iframe' lay-tips="+data[i].resName+" lay-direction=\"2\">\n" +
                        "                            <i class=\"layui-icon layui-icon-home\"></i>\n" +
